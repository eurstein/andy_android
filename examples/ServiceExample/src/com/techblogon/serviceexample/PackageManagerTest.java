...
//        for (int i = 0; i < 100; i++) {
//            getPackageArchiveInfo(context, "/sdcard/local/apk/com.wandoujia.phoenix2_7893_2.apk");
//            getPackageArchiveInfo(context, "/sdcard/local/apk/com.UCMobile_156_2.apk");
//        }
//        AndyLog.i(TAG, "getPackageArchiveInfo 100 times cost: " + (System.currentTimeMillis() - start));
    }
