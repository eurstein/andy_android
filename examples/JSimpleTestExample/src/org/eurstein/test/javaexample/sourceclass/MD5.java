...
public class MD5 {
    ...
    */
    ...
    private byte[] getMD5(byte inbuf[]) {
        md5Init();
...
//     }
    ...
    */
     ...
     * @param source
     * @return
     * @deprecated This method is too slow, use {@link #toMD5(String)} instead.
     */
     ...
     * @return
     */
	public static String inputStreamToMd5(InputStream is) {
		try {
    ...
    public static String getFileMD5old(File sourceFile) {
